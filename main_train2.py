...
from modules.trainer2 import Trainer
...
def main():
    ...
    optimizer2 = build_optimizer(args, model2)
    lr_scheduler = build_lr_scheduler(args, optimizer)
    lr_scheduler2 = build_lr_scheduler(args, optimizer2)

    # build trainer and start to train
    trainer = Trainer(model,model2, criterion, metrics, optimizer,optimizer2, args, lr_scheduler,lr_scheduler2, train_dataloader, val_dataloader, test_dataloader)
    trainer.train()
